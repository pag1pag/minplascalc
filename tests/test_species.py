...
def test_partitionfunction_translational(diatomic_sample_species):
    partition_function = diatomic_sample_species.translational_partition_function(0)
    assert partition_function == 0


def test_partitionfunction_internal(diatomic_sample_species):
    partition_function = diatomic_sample_species.internal_partition_function(300, 0)
